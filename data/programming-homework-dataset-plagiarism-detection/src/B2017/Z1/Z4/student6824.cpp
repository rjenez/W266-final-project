/*B 2017/2018, Zadaća 1, Zadatak 4
	...
	javnim autostudent6824ovima. Zalbe za ne analiziranje student6824ova
	se ne uvazavaju!
	
	NAPOMENA: nece svi (javni) student6824ovi sa zamgera biti 
	dostupni na c9.

	Za sva ostala pitanja i nedoumice vezane za 
	autostudent6824ove javiti se na email: bcocalic1@etf.unsa.ba.	
*/
#include <iostream>
#include <string>
#include <vector>

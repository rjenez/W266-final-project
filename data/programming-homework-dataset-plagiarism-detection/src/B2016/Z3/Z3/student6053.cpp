...
template<typename TipElemenata>
Matrica<TipElemenata>MatricniPolinom(const Matrica<TipElemenata> &m, std::vector<int> v){
...
cout<<"Unesi dimenziju vektora: "<<endl;
cin>>dim;
cout<<"Unesite elemente vektora: "<<endl;
for(int i=0;i<dim;i++)
cin>>v[i];
cout<<"Proizvod matrica: "<<endl;
IspisiMatricu(d=MatricniPolinom(a,v),7);
}
catch(std::bad_alloc) {

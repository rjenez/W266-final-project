...
Dijete *KreirajPovezanuListu(std::vector<std::string> imena) {
    Dijete *pocetak(nullptr), *prethodni;
    for (int i=0; i<imena.size(); i++) {
        Dijete *novi(new Dijete); //Kreiramo novi cvor, da li provjeravamo uspjesnost alokacije?

...
void obrisi(){
    if(t==poc && poc->sljedeci!=nullptr){
             ...
             /*else if(t->sljedeci==nullptr){
                 ...
                 t=pom;
                 t->sljedeci=poc;
                 std::cout<<"Obrisao zadnji";//iako ja nmg znati koji mi je zadnji jer sam stavila da je cirkularna
             }*/
             /*else if(poc==t && poc->sljedeci==nullptr){//ovo mi je bas visak
                 delete t;
                 t=poc=nullptr;
                 std::cout<<"druga fun__";
             }*/
             else { 
                 Dijete *pom=poc;
                 while(pom->sljedeci!=t)pom=pom->sljedeci;
...
std::vector<std::set<std::string>> Razvrstavanje(std::vector<std::string> v, int k){
     ...
     for(int i=0;i<k;i++){
       ...
       //std::cout<<(t->ime).size();
             ...
             else if(t->sljedeci->sljedeci==t){//imam 2 elemnta
              Dijete *pom=t;
              pom=t->sljedeci;

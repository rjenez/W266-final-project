...
int main ()
{
    try
    {
        Temperature t(-30, 30);
            ...
            std::cout << "Maximalna temperatura: " << t.DajMaksimalnuTeperaturu() << std::endl;
            std::cout << "Broj temperatura vecih od 10: " << t.DajBrojTeperaturaVecihOd(10) << std::endl;
            std::cout << "Broj temperatura manjih od 6: " << t.DajBrojTeperaturaManjihOd(6) << std::endl;

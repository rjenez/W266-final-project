...
class Knjiga
{
    ...
    shared_ptr<Korisnik> DajKodKogaJe() {return pok;}
    
    void ZaduziKnjigu(Korisnik k)
    {
        pok = make_shared<Korisnik>(k);
    }
...
class Biblioteka
{
    ...
    void RegistrirajNovogKorisnika(int id, string i, string p, string a, string t)
    {
        ...
        korisnici.insert(make_pair(id, make_shared<Korisnik>(i, p, a, t)));
    }
    ...
    void RegistrirajNovuKnjigu(int id, string i, string p, string z, int g)
    {
        ...
        knjige.insert(make_pair(id, make_shared<Knjiga>(i, p, z, g)));
    }

...
class Knjiga{
    ...
    shared_ptr<Korisnik>pok_zaduzenja;
    public:
    ...
    shared_ptr<Korisnik> DajKodKogaJe() const{ return pok_zaduzenja; }
    void ZaduziKnjigu(Korisnik &a){ pok_zaduzenja=make_shared<Korisnik>(a); }
...
class Biblioteka{
    ...
    void RegistrirajNovogKorisnika(int clanski_broj, string ime, string prezime, string adresa, string telefon){
        Korisnik x{ime, prezime, adresa, telefon};
        shared_ptr<Korisnik> k(make_shared<Korisnik> (x));
    ...
    void RegistrirajNovuKnjigu(int evidencijski_broj_knjige, string naslov_knjige, string ime_pisca, string zanr, int godina_izdavanja){
        Knjiga x{naslov_knjige, ime_pisca, zanr, godina_izdavanja};
        shared_ptr<Knjiga> k(make_shared<Knjiga> (x));

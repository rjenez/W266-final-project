...
public:
    ...
    Biblioteka(const Biblioteka&b) {
        ...
        for(auto it=b.korisnici.begin(); it!=b.korisnici.end(); it++) {
            korisnici[it->first] = make_shared< Korisnik>(*it->second);
        }
        for(auto it=b.knjige.begin(); it!=b.knjige.end(); it++) {
            knjige[it->first] = make_shared <Knjiga>(*it->second);
        }
    }
    ...
    void RegistrirajNovogKorisnika(int clanskiBroj, string ime, string prezime, string adresa, string telefon) {
        ...
        korisnici[clanskiBroj] = make_shared< Korisnik> ( Korisnik {ime,prezime,adresa,telefon});
    }
    ...
    void RegistrirajNovuKnjigu(int evidencijskiBroj, string naslov, string imePisca, string zanr, int godina) {
        ...
        knjige[evidencijskiBroj] = make_shared< Knjiga>(naslov,imePisca,zanr,godina);
    }
    ...
    void PrikaziZaduzenja(int clanskiBroj) {
        ...
        Korisnik* k = korisnici[clanskiBroj].get();
        for(auto it=knjige.begin(); it!=knjige.end(); it++) {

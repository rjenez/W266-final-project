...
Biblioteka::Biblioteka(){
    std::map<int, Korisnik*> p1;
    std::map<int, Knjiga*> p2;
...
void Biblioteka::RegistrirajNovuKnjigu(int broj_knjige, std::string naslov,  std::string ime_pisca, std::string zanr, int godina_izdavanja){
    ...
    knjige.insert(std::make_pair(broj_knjige, new Knjiga(Knjiga(naslov, ime_pisca, zanr, godina_izdavanja))));
}

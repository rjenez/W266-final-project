...
public:
    ...
    Knjiga(std::string NASLOV, std::string IME, std::string ZANR, int GODINA): korisnik(nullptr) {
...
int main ()
{
    ...
    std::string I, P, A;
    std::cout<<"Unesite ime clana biblioteke: ";
    std::cin>>I;
    std::cout<<"Unesite prezime clana biblioteke: ";
    std::cin>>P;
    std::cout<<"Unesite broj telefona novog clana: ";
    std::string brojj;
    std::cin>>brojj;
    std::cout<<"Unesite adresu clana: ";
    std::cin>>A;

    biblioteka.RegistrirajNovogKorisnika(25, I, P, A, brojj);
    
    biblioteka.RegistrirajNovuKnjigu(25, "Dervis i smrt", "Mesa Selimovic", "Roman2", 1966);
    biblioteka.RegistrirajNovuKnjigu(30, "Dervis i smrt", "Mesa Selimovic", "Roman", 1963);
    
    biblioteka.ZaduziKnjigu(30, 25);

...
class Biblioteka{
    ...
    Biblioteka()=default;
    ~Biblioteka(){
        for(auto pok(clanovi.begin());pok!=clanovi.end();pok++)
        delete (pok->second);
    ...
    Biblioteka(const Biblioteka &b){
        ...
        for(auto p(b.knjige.begin());p!=b.knjige.end();p++){
            Knjiga *k=new Knjiga(p->second->naslov,p->second->autor,p->second->zanr,p->second->izdana);
    ...
    void RegistrirajNovuKnjigu(int br,std::string imee,std::string pisa,std::string znr,int godin){
        ...
        auto k=new Knjiga(imee,pisa,znr,godin);
    ...
    void PrikaziZaduzenja(int br){
        ...
        for(auto pok(knjige.begin());pok!=knjige.end();pok++){
            if(pok->second->zaduzena==p->second){

...
public:
    ...
    Biblioteka(Biblioteka &b){
        ...
        for(auto x : b.knjige){
            int broj = x.first;
            Knjiga *knjiga = new Knjiga((x.second)->DajNaslov(), (x.second)->DajAutora(), (x.second)->DajZanr(), (x.second)->DajGodinuIzdavanja());
    ...
    void RegistrirajNovuKnjigu(int ev_broj_knjige, std::string naziv, std::string autor, std::string zanr, int godina){
        ...
        Knjiga *knjiga = new Knjiga(naziv, autor,zanr , godina);

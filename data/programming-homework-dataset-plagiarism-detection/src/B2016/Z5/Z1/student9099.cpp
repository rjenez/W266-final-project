...
int main() {
    ...
    while(1) {
        ...
        if(unos == 1) {
            ...
            BIBLIOTEKA.RegistrirajNovogKorisnika(korisnicki_broj, ime, prezime, adresa, broj_telefona);
        }
        else if(unos == 2) {
            int evidencijski_broj, godina_izdavanja;
            string naslov, ime_pisca, zanr;
            ...
            cin >> evidencijski_broj;
            try {
                Korisnik trazeni = BIBLIOTEKA.NadjiKorisnika(evidencijski_broj);
                trazeni.Ispisi();
            }
            ...
            cin >> evidencijski_broj;
            try {
                Knjiga trazena = BIBLIOTEKA.NadjiKnjigu(evidencijski_broj);
                trazena.Ispisi();
            }
            ...
            cin >> korisnicki_broj;
            try { BIBLIOTEKA.ZaduziKnjigu(evidencijski_broj, korisnicki_broj); }
            ...
            cin >> evidencijski_broj;
            try { BIBLIOTEKA.RazduziKnjigu(evidencijski_broj); }
            ...
            cin >> evidencijski_broj;
            try { BIBLIOTEKA.PrikaziZaduzenja(evidencijski_broj); }
            catch (domain_error greska) { cout << greska.what() << endl; }
        }
        else if(unos == 10) {
            cout << "Dovidjenja";
            ...
            cout << "Pogresan unos. Trebate unijeti broj 1-10. Pokusajte ponovo! \n";
        }

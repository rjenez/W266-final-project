...
def factory():
    str1 = "Early today Lamar and Patty reached a deal to fund subsidies that were to be ended quickly"
    str2 = "Early today Lamar and Barbara agreed that the subsidies that were to be ended quickly needed to be funded"
